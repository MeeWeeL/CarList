...
object Config {
    const val application_id = "com.meeweel.carlist"
...
object Dagger {
    ...
    const val dagger_compiler_kapt = "com.google.dagger:dagger-compiler:2.41"
    const val dagger_android_processor_kapt = "com.google.dagger:dagger-android-processor:$dagger_version"
}

object Room {
    const val room_runtime = "androidx.room:room-runtime:$room_version"
    const val room_rxjava3 = "androidx.room:room-rxjava3:$room_version"
    const val room_compiler_kapt = "androidx.room:room-compiler:$room_version"
}
...
object Retrofit {
    ...
    const val retrofit2_adapter_rxjava3 = "com.squareup.retrofit2:adapter-rxjava3:$retrofit_version"
}

object OkHttp {
    const val okhttp3 = "com.squareup.okhttp3:okhttp:$okhttp_version"
    const val okhttp3_logging_interceptor = "com.squareup.okhttp3:logging-interceptor:$okhttp_version"
}

object RxJava3 {
    const val rxjava3_rxAndroid = "io.reactivex.rxjava3:rxandroid:$rx_version"
    const val rxjava3 = "io.reactivex.rxjava3:rxjava:$rx_version"
}

object NavComponent {
    const val nav_component_fragment = "androidx.navigation:navigation-fragment-ktx:$nav_version"
    const val nav_component_ui_ktx = "androidx.navigation:navigation-ui-ktx:$nav_version"
}
...
object Annotations {
    const val annotation_library = "com.intellij:annotations:12.0"
}